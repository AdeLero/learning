...
class TheColors {
  ...
  static Color mustard = const Color(0xFFD49007);
  static Color paleBlue = const Color(0xFFAFCBF6);
  static Color wine = const Color(0xFFC51F44);
  static Color grey = const Color(0xFFb1b1b1);
  static Color faintGrey = const Color(0xFFd9d9d9);
